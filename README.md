...
- **audio-mir** — audio / MIR / music-theory / LLM-music tooling for the **ASA** project, plus **Harmonia** as a **conceptual-reference** target (a real but unpublished single-file tool — chord/theory repos kept as idea references, not scored as forks).
