...
- **[`audio-mir.md`](audio-mir.md)** — audio / MIR / music-theory tooling for ASA and as a
  conceptual-idea bench for Harmonia (unpublished single-file vanilla JS; reference-only). →
  `discoveries/audio-mir-<date>.md` · `discoveries/_seen.txt` · `RECOMMENDATIONS.md`
