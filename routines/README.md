...
- **[`audio-mir.md`](audio-mir.md)** — audio / MIR / music-theory / LLM-music tooling for the ASA
  project, plus **Harmonia** as a conceptual-reference target (real but unpublished; not a scored repo). → `discoveries/audio-mir-<date>.md` · `discoveries/_seen.txt` · `RECOMMENDATIONS.md`
