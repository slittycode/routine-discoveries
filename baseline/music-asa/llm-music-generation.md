...
audition-sample generation. Scores are **1–5 relevance** to ASA + flag: `ASA` · `H`
(**conceptual reference for Harmonia**, an unpublished single-file tool — not a scored
repo; see `../README.md`) · `Both` · `tang`. Corrected scores
