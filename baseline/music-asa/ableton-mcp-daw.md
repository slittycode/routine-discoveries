...
flag: `ASA` · `H` (Harmonia = **conceptual reference only**, unpublished single-file
vanilla JS; see `../README.md`) · `Both` · `tang`. Corrected scores follow
`discoveries/reanalysis-2026-05-20.md` (native + LLM/MCP + Ableton tooling are
first-class; browser/WASM credit removed; Harmonia framing further corrected
2026-05-26).
